...
| [Reactor](Source/com.reactor.feed/) | 0.1.3 | Optimized Reactor Mag RSS — branded icon, cleaned WordPress hero chrome, dek, bylines |
| [Product Hunt](Source/com.producthunt.feed/) | 0.1.0 | Topic Atom feed (default `tech`) — branded icon; optional Developer Token for screenshots |
