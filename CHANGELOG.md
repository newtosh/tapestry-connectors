...
## [com.youtube.playlist 0.1.0] - 2026-07-30

### Added

- New YouTube Playlist connector that accepts playlist URLs (stock `com.youtube` rejects them) via YouTube’s public `playlist_id` Atom feed.
